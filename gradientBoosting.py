...
char_col_toUse_names = ['Customer' ,'Well_Environment','Well_Type','HoleSizeRange','AMR_Tool']
num_col_toUse_names = ['Hole Section Duration','Tool Occurence', '% of Tool Occurence', 'Tool Days % of Duration']

taxiFile = sc.textFile("hdfs://ittpunedevha/tmp/adubey4/WL_BOR_Assets_07_Apr.csv")
#taxiFile.count()
